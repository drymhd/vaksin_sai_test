...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row invoice-card-row">
            <div class="col-xl-4 col-md-6 col-xxl-4 col-sm-12">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Total Pengguna</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-xxl-4 col-sm-12">
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ $data['faskes'] }}</h2>
                            <span class="text-white fs-18">Total Faskes</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-xxl-4 col-sm-12">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ $data['vaksin'] }}</h2>
                            <span class="text-white fs-18">Total Tipe Vaksin</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="alert alert-light solid alert-dismissible fade show">
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-1 mb-2">Fasilitas Kesehatan</h5>
                    <p class="mb-0">Menampilkan data jumlah faskes yang tersedia dikelompokan berdasarkan tipe Fasilitas Kesehatan</p>
                </div>
            </div>
        </div>
        ...
        <div class="alert alert-light solid alert-dismissible fade show">
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-1 mb-2">Vaksin</h5>
                    <p class="mb-0">Menampilkan data vaksin yang tersedia di kelompokan berdasarkan jenis/merek vaksin</p>
                </div>
            </div>
        </div>

        <div class="row invoice-card-row owl-carousel">
