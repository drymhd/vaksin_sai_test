...
<head>
    ...
    <title>Vaksinasi | @yield('title')</title>
        ...
        <div id="main-wrapper">
            ...
            <div class="nav-header">
                <a href="index.html" class="brand-logo">
                    <image class="logo-abbr" width="53" height="53" src="{{ asset('images/logo/logo.svg') }}">
                    </image>
                    <image class="brand-title" width="124px" height="33px" src="{{ asset('images/logo/text.svg') }}">
                    ...
                    <ul class="metismenu" id="menu">
                        <li class="dropdown header-profile">
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                <img src="{{ Auth::user()->photo_url }}" width="20" alt="" />
                        ...
                        <li><a href="{{ route('vaksin.index') }}" class="ai-icon" aria-expanded="false">
                                <i class="flaticon-381-plus"></i>
                                <span class="nav-text">Vaksin</span>
                            </a>
                        </li>
                        <li><a href="{{ route('faskes.index') }}" class="ai-icon" aria-expanded="false">
    ...
    @else
        <div class="content-body">
            @if ($message = Session::get('success'))
                <div class="alert alert-success solid alert-dismissible fade show mx-5">
            ...
            @endif
            @if ($errors->any())
                <div class="alert alert-danger solid alert-dismissible fade show mx-5">
                    <svg viewBox="0 0 24 24" width="24 " height="24" stroke="currentColor" stroke-width="2"
                        fill="none" stroke-linecap="round" stroke-linejoin="round" class="me-2">
